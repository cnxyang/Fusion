...
__host__ __device__ inline uchar3 make_uchar3(int a) {
	return make_uchar3(a, a, a);
}

__host__ __device__ inline uchar3 make_uchar3(float3 a) {
...
__host__ __device__ inline int2 make_int2(float2 a) {
...
__host__ __device__ inline int3 make_int3(float3 a) {
	return make_int3((int) a.x, (int) a.y, (int) a.z);
}

__host__ __device__ inline int4 make_int4(int3 a, int b) {
...
__host__ __device__ inline int3 make_int3(float a) {
...
__host__ __device__ inline float3 operator+(int3 a, float3 b) {
...
__host__ __device__ inline void operator+=(float3 & a, uchar3 b) {
	a.x += b.x;
	a.y += b.y;
	a.z += b.z;
}

__host__ __device__ inline void operator+=(float3 & a, float3 b) {
	a.x += b.x;
	a.y += b.y;
	a.z += b.z;
}
...
__host__ __device__ inline float operator*(float3 a, float3 b) {
	return a.x * b.x + a.y * b.y + a.z * b.z;
}

__host__ __device__ inline float operator*(float3 a, float4 b) {
	return a.x * b.x + a.y * b.y + a.z * b.z;
}

__host__ __device__ inline float operator*(float4 a, float3 b) {
	return a.x * b.x + a.y * b.y + a.z * b.z + a.w;
}

__host__ __device__ inline float operator*(float4 a, float4 b) {
...
__host__ __device__ inline int3 operator*(int3 a, unsigned int b) {
...
__host__ __device__ inline int3 operator*(float3 a, int b) {
	return make_int3(a.x * b, a.y * b, a.z * b);
}
...
__host__ __device__ inline float2 operator/(float2 a, int b) {
...
__host__ __device__ inline bool operator==(int3 a, int3 b) {
	return a.x == b.x && a.y == b.y && a.z == b.z;
}
...
__host__  __device__  inline float3 cross(float4 a, float4 b) {
	return make_float3(a.y * b.z - a.z * b.y,
			           a.z * b.x - a.x * b.z,
			           a.x * b.y - a.y * b.x);
}
...
__host__ __device__ inline float norm(float4 a) {
	return sqrt(a * a);
}

__host__ __device__ inline float inv_norm(float3 a) {
	return 1.0 / sqrt(a * a);
}

__host__ __device__ inline float inv_norm(float4 a) {
	return 1.0 / sqrt(a * a);
}

__host__ __device__ inline float3 normalised(float3 a) {
	return a / norm(a);
}

__host__ __device__ inline float4 normalised(float4 a) {
	return a / norm(a);
}

__host__ __device__ inline float3 floor(float3 a) {
	return make_float3(floor(a.x), floor(a.y), floor(a.z));
}

__host__ __device__ inline float3 fmaxf(float3 a, float3 b) {
	return make_float3(fmaxf(a.x, b.x), fmaxf(a.y, b.y), fmaxf(a.z, b.z));
}

__host__ __device__ inline float3 fminf(float3 a, float3 b) {
